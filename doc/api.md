...
| Endpoint                            | Method | Description                                                                                 | Required Parameters                                                           | Optional Parameter                                  | Required body parameter                          |     |
|-------------------------------------|--------|---------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------------|--------------------------------------------------|-----|
...
| `/blob/files`                       | POST   | Used to create a file                                                                       | `bucketID`, `creationTime`, `prefix`, `method`, `fileName`, `fileHash`, `sig` | `notifyEmail`, `retentionDuration`                  | `file` (as formData)                             |     |
...
| `/blob/files/{identifier}`          | PUT    | Used to change the filename with given {id}                                                 | `bucketID`, `creationTime`, `method`, `fileName`, `sig`                       |                                                     | `fileName` and/or `additionalMetadata` (as JSON) |     |
