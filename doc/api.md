...
|-------------------------------------|--------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|----------------------------------------------------------|------------------------------------------|
| `/blob/files`                       | GET    | Used to GET a collection of files                                                           | `bucketID`, `creationTime`, `prefix`, `sig`                                     | `includeData`                                            | -                                        |
...
| `/blob/files`                       | POST   | Used to create a file                                                                       | `bucketID`, `creationTime`, `prefix`, `method`, `fileName`, `fileHash`, `sig`   | `notifyEmail`, `retentionDuration`, `additionalMetadata` | `file`, `prefix`, `fileName`, `bucketID` |
| `/blob/files`                       | DELETE | Used to DELETE the files with given prefix                                                  | `bucketID`, `creationTime`, `prefix`, `method`, `sig`                           |                                                          | -                                        |
...
| `blob:get-file-data-collection-missing-prefix`           | 400         | The prefix parameter `prefix` is missing                                                                                      |                    |         |
