...
final class Version20221011110238 extends EntityManagerMigration
{
    ...
    {
        $this->addSql('CREATE TABLE blob_files (identifier VARCHAR(50) NOT NULL, prefix VARCHAR(255) NOT NULL, file_name VARCHAR(50) NOT NULL, bucket_id VARCHAR(50) NOT NULL, date_created DATETIME NOT NULL, last_access DATETIME NOT NULL, retention_duration VARCHAR(50) NOT NULL, idle_retention_duration VARCHAR(50) NOT NULL, content_url VARCHAR(255) NOT NULL, additional_metadata LONGTEXT NOT NULL, PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
