            ...
            ->getRootNode()
                ->children()
                    ->scalarNode(self::DATABASE_URL)
                        ->isRequired()
                        // ->cannotBeEmpty()
                        ->example('%env(resolve:BLOB_DATABASE_NAME)%')
                    ->end()
                    ...
                    ->scalarNode('filedata_schema')
                        ->isRequired()
                        ->example('%kernel.project_dir%/vendor/dbp/relay-blob-bundle/src/Resources/filedata-v1.schema.json')
                    ->end()
                    ...
                    ->scalarNode('bucket_size_check_interval')
                        ...
                        ->example('0 2 * * 1')
                    ->end()
                    ->scalarNode('metadata_size_limit')
                        ->isRequired()
                        ->example('1000000')
                    ->end()
                    ->arrayNode('buckets')
